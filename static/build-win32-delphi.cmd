...
set SRC=adler32.c crc32.c utils.c deflate_compress.c deflate_decompress.c zlib_decompress.c zlib_compress.c gzip_decompress.c gzip_compress.c

bcc32x %CFLAGS% -D_WIN32 -D_ANSI_SOURCE -D__GNUC__ -I.. -c %SRC%

move *.obj ..\..\static\libdeflate-delphi\win32\
